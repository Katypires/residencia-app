...
. 
        ...
        {{-- <div class="grid-container flex-grow-1 overflow-auto">
            ...
            <div class="card text-white bg-primary border border-black g    rid-item">
                <div class="card-body text-center">
        ...
        <div class="container my-2 mb-3 overflow-auto w-100 ">
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
                <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
                    <h1 class="display-4 fw-bold lh-1 text-body-emphasis">Processo seletivo para Residência</h1>
                    <p class="lead">Lorem ipsum dolor sit amet. Ut quisquam laboriosam qui alias iusto et nostrum
                        illum ut sapiente iure eos quos consectetur sed dolorum nobis. Eos deleniti nostrum et galisum
                        sunt ea voluptate quisquam id tenetur asperiores.</p>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
                        <button type="button" class="btn btn-primary btn-lg px-4 me-md-2 fw-bold"><i
                                class="fas fa-pencil-alt"></i> Inscrever-se</button>
                        <button type="button" class="btn btn-outline-secondary btn-lg px-4"><i
                                class="fas fa-file-alt"></i> Edital</button>
                    </div>
                </div>
            ...
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
                <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
                    <h1 class="display-4 fw-bold lh-1 text-body-emphasis">Processo seletivo exemplo</h1>
                    <p class="lead">Lorem ipsum dolor sit amet. Ut quisquam laboriosam qui alias iusto et nostrum
                        illum ut sapiente iure eos quos consectetur sed dolorum nobis. Eos deleniti nostrum et galisum
                        sunt ea voluptate quisquam id tenetur asperiores.</p>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
