<div class="row g-3">
    ...
    <div class="form-floating col-12 mb-3">
        ...
        @error('tipo_formacao') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="form-floating col-12 mb-3">
        ...
        @error('tipo_duracao') <span class="text-danger">{{ $message }}</span> @enderror
    </div>

    <div class="form-floating col-12 mb-3">
        <input type="number" class="form-control" id="duracao" wire:model.defer="data.duracao" placeholder="Duração">
        <label for="duracao" class="form-label">Duração</label>
        @error('duracao') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
