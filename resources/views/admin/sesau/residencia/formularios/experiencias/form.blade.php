<div class="row g-3">
    <div class="form-floating col-12 mb-3">
        <select class="form-control" id="candidato_id" wire:model.defer="data.candidato_id">
            ...
            <!-- As opções de candidatos devem ser carregadas dinamicamente -->
        </select>
    ...
    <div class="form-floating col-12 mb-3">
        <input type="text" class="form-control" id="cargo_funcao" wire:model.defer="data.cargo_funcao" placeholder="Cargo/Função">
        <label for="cargo_funcao" class="form-label">Cargo/Função</label>
        @error('cargo_funcao') <span class="text-danger">{{ $message }}</span> @enderror
    </div>

    <div class="form-floating col-12 mb-3">
        <input type="text" class="form-control" id="area_atuacao" wire:model.defer="data.area_atuacao" placeholder="Área de Atuação">
        <label for="area_atuacao" class="form-label">Área de Atuação</label>
        @error('area_atuacao') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="form-floating col-12 mb-3">
        <input type="date" class="form-control" id="data_saida" wire:model.defer="data.data_saida" placeholder="Data de Saída">
        <label for="data_saida" class="form-label">Data de Saída</label>
        @error('data_saida') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
</div>
