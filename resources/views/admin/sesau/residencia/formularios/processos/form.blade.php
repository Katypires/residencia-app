<div class="row g-3">
    <div class="form-floating col-12 mb-1">
        ...
        @error('data.tipo_processo_id') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="form-floating col-12 mb-1">
        ...
        @error('data.cedente_id') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="form-floating col-12 mb-1">
        ...
        @error('data.descricao') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="form-floating col-6 mb-1">
        ...
        @error('data.data_inicio') <span class="text-danger">{{ $message }}</span> @enderror
    </div>

    <div class="form-floating col-6 mb-1">
        <input type="date" class="form-control" id="data_final" wire:model.defer="data.data_final">
        <label for="data_final" class="form-label">Data Final @error('data.data_final') <span class="text-danger" title="{{ $message }}">*</span> @enderror</label>

    </div>

    <div class="form-floating col-6 mb-1">
        <input type="date" class="form-control" id="data_vencimento" wire:model.defer="data.data_vencimento">
        <label for="data_vencimento" class="form-label">Data de Vencimento @error('data.data_vencimento') <span class="text-danger" title="{{ $message }}">*</span> @enderror</label>
    </div>
    ...
    <div class="form-floating col-6 mb-1">
        ...
        <label for="situacao" class="form-label">Situação @error('data.situacao') <span class="text-danger">*</span> @enderror</label>
    ...
    <div class="form-check col-12 mb-1">
        ...
        @error('data.formacao') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="form-check col-12 mb-1">
        ...
        @error('data.qualificacao') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="form-check col-12 mb-1">
        ...
        @error('data.experiencia') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
