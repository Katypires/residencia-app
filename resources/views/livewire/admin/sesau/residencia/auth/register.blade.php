            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nome_social" class="col-md-4 col-form-label text-md-end">Nome social</label>

                            <div class="col-md-6">
                                <input id="nome_social" type="text" class="form-control @error('nome_social') is-invalid @enderror" name="nome_social" value="{{ old('nome_social') }}" autocomplete="nome_social" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Confirme senha</label>
