<div class="wrapper">
  <div class="container">
    ...
    <div class="bloco-superior">
      ...
      <div class="cabecalho">
        <div class="logo-bb">
            {{-- <img class="col-2" src="{{ public_path('assets/images/semraiva/SESAU_DIGITAL_02.png') }}" alt="Logo prefeitura" style="width: 150px;"> --}}
          <img src="{{ public_path('assets/boleto/bb.png') }}" alt="Logo banco do brasil">
        </div>
        <div class="codigo-banco-com-dv">
          <p>{{$codigoBancoMoeda}}</p>
        </div>
        ...
        <div class="container-flex">
            <div class="linha-2">
                <div class="instrucoes">
                    ...
                    <p>Boleto do Pedido #1</p>
                    <p>Não receber após o vencimento ou abaixo do valor do documento</p>
                    <p>Não receber por cheque</p>
                    <p>Não receber por cheque</p>
                    <p>Não receber por cheque</p>
                    <p>Não receber por cheque</p>
                </div>
            ...
            <div class="linha-5">
                <div class="linha-6">
                    <div class=" campo-2 desconto-abatimento-inferior">
                        <h4>(-) Desconto / Abatimento</h4>
                        <p></p>
                    </div>
                ...
                <div class="linha-6">
                    <div class="campo-2 outras-deducoes-inferior">
                        <h4>(-) Outras deduções</h4>
                        <p></p>
                    </div>
                ...
                <div class="linha-6">
                    <div class=" campo-2 mora-multa-inferior">
                        <h4>(+) Mora / Multa</h4>
                        <p></p>
                    </div>
                </div>
                <div class="linha-6">
                    <div class="campo-2 outros-acrescimos-inferior">
                        <h4>(+) Outros acréscimos</h4>
                        <p></p>
                    </div>
                ...
                <div class="linha-6">
                    <div class="campo-2 valor-cobrado-inferior">
                        <h4>(=) Valor cobrado</h4>
                        <p></p>
                    </div>
